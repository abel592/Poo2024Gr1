...
public class MainCliente extends javax.swing.JPanel {
    ...
    private void paintForm() {
        if (jTable1.getSelectedRow() != -1) {
            ...
            txtDirecion.setText(d.getDireccion());
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtDni)
                    .addComponent(txtDirecion, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Nombre Pro.", "Precio Pro.", "T.Doc", "Dirección"
            }
        ));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/donpepe.jpg"))); // NOI18N
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        to.setDireccion(txtDirecion.getText());
            ...
            try {
                ...
                if (resultado != null) {
                    ...
                    Object nuevo[] = {fila + 1, to.getDniruc(), to.getNombrers(),
                        to.getDocumento(),to.getDireccion()};
                ...
                if (JOptionPane.showConfirmDialog(this, "Esta seguro de crear un nuevo producto?", "Mensaje de confirmación", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE) == 0) {
                    if (clienteService.guardarEntidad(to) != null) {
                        ...
                        Object nuevo[] = {modelo.getRowCount() + 1, to.getDniruc(),
                            to.getNombrers(), to.getDocumento(),to.getDireccion()};
                        modelo.addRow(nuevo);
                        resetForm();
                    }
                }
